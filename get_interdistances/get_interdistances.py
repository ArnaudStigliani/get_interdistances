...
parser.add_argument("--points", "-points", type = bool, default= False)
...
#python get_interdistances.py -fac "ARF5" -pc 0.001 -maxInter 20 -th -10 -11 -12 -neg ../sequences/ARF5_neg1.fas ../sequences/ARF5_neg2.fas ../sequences/ARF5_neg3.fas ../sequences/ARF5_neg4.fas -points True
...
if negative_sets :
	for a,b,c,d,e,f in zip(InterDR,InterER,InterIR,InterDR_N,InterER_N,InterIR_N) :
		...
		rate_DR = divide(sum(a), sum(d))
		rate_ER = divide(sum(b) , sum(e))
		rate_IR = divide(sum(c) , sum(f))
